...
#1) Load R image
load("./Data/SARS-CoV-2_Modeling_20220711.RData")
...
pdf(paste0("./Results/20220711_Results/shotgun_umap_umap_doms_vital_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height = 6, width = 14)
...
pdf(paste0("./Results/20220711_Results/card_heatmap_total_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height = 60, width = 16, onefile = F)
gg_card_heatmap
dev.off()
...
pdf(paste0("./Results/20220711_Results/card_heatmap_family_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height = 8, width = 20, onefile = F)
...
pdf(paste0("./Results/20220711_Results/toxins_heatmap_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height = 2.9, width = 16)
gg_toxin_heatmap_tot
dev.off()
```
...
pdf(paste0("./Results/20220711_Results/operon_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height = 4, width = 6, onefile = F)
...
pdf(paste0("./Results/20220711_Results/bacteriocins_toxins_card_heatmap_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height = 10, width = 14)
draw(ht_list, ht_gap = unit(1, "cm"))
dev.off()

pdf(paste0("./Results/20220711_Results/unadjusted_heatmap_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height = 10, width = 14)
draw(unadj_list, ht_gap = unit(1, "cm"))
dev.off()

pdf(paste0("./Results/20220711_Results/adjusted_heatmap_", format(Sys.Date(), format = "%Y%m%d"),".pdf"),  height = 10, width = 14)
...
ggsave(plot = volcano, paste0("./Results/20220711_Results/volcano_plot_total_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), width = 12, height = 8, units = "in")
```
...
pdf(paste0("./Results/20220711_Results/covid_quant_metab_vital_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height =4, width = 12)
quant_vital_tot
dev.off()
#### Metabolites END ####
```
...
pdf(paste0("./Results/20220711_Results/Figure_3_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height = 14, width = 16)
...
write.csv(tab1_2, paste0("./Results/20220711_Results/Table_1_", format(Sys.Date(), format = "%Y%m%d"),".csv"), row.names = TRUE)

# Need to adjust pvalues
tab1_2_padjust <- read.csv(paste0("./Results/20220711_Results/Table_1_", format(Sys.Date(), format = "%Y%m%d"),".csv"))
...
write.csv(tab1_2_padjust, paste0("./Results/20220711_Results/Table_1_padjust_", format(Sys.Date(), format = "%Y%m%d"),".csv"), row.names = TRUE)
```
...
write.csv(tab2_2, paste0("./Results/20220711_Results/Table_2_", format(Sys.Date(), format = "%Y%m%d"),".csv"), row.names = TRUE)

# Need to adjust pvalues
tab2_2_padjust <- read.csv(paste0("./Results/20220711_Results/Table_2_", format(Sys.Date(), format = "%Y%m%d"),".csv"))
...
# Read in csv to then append adjusted pvalues
write.csv(tab2_2_padjust, paste0("./Results/20220711_Results/Table_2_padjust_", format(Sys.Date(), format = "%Y%m%d"),".csv"), row.names = TRUE)
```
...
cutpoints_unnest %>% 
  ...
  arrange(compound) %>% 
write.csv(., paste0("./Results/20220711_Results/Table_3_", format(Sys.Date(), format = "%Y%m%d"), ".csv"), row.names = F)
```
...
gtsave(as_gt(coxauc),
       file = paste0("./Results/20220711_Results/Table_4_", format(Sys.Date(), format = "%Y%m%d"), ".png"))
```
...
gtsave(as_gt(log_t5_1),
       file = paste0("./Results/20220711_Results/Table_5_", format(Sys.Date(), format = "%Y%m%d"), ".png"))
```
...
write.csv(tab_s1_2, paste0("./Results/20220711_Results/Table_S1_", format(Sys.Date(), format = "%Y%m%d"),".csv"), row.names = TRUE)

# Need to adjust pvalues
tab_s1_2_padjust <- read.csv(paste0("./Results/20220711_Results/Table_S1_", format(Sys.Date(), format = "%Y%m%d"),".csv"))
...
# Read in csv to then append adjusted pvalues
write.csv(tab_s1_2_padjust, paste0("./Results/20220711_Results/Table_5_padjust_", format(Sys.Date(), format = "%Y%m%d"),".csv"), row.names = TRUE)
```
...
ggsave(plot = gg_emapper_box, file = paste0("./Results/20220711_Results/Figure_S2_",format(Sys.Date(), format = "%Y%m%d"), ".pdf"), width = 14, height = 10, units = "in")
```
...
pdf(paste0("./Results/20220711_Results/Figure_S3_", format(Sys.Date(), format = "%Y%m%d"),".pdf"), height = 12, width = 17, onefile = F)
gg_covid_heatmap
dev.off()
...
save.image(file = paste0("./Data/SARS-CoV-2_Modeling_", format(Sys.Date(), format = "%Y%m%d"), ".RData"))
```
